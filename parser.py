...
def create_segments():
    ...
    def parse_education_segment(user):
        ...
        for i in range(0,len(education_segment)):
            ...
            if not university_flag:
                for university, addr_list in university_word_dict.items():
    ...
    show(education_segment)
    print ("***************************************************************************************************")
    print ("Skill segment: ") 
    show(skill_segment)
    print ("***************************************************************************************************")
    print ("Project segment: ") 
    show(project_segment)
    print ("***************************************************************************************************")
    print ("Other segment: ") 
    show(other_segment)
    print ("***************************************************************************************************")
            ...
            if lt_obj not in visited:
                ...
                if university_flag:
                    ...
                    if not degree_flag:
                        ...
                        addr_list = university_word_dict.get(closest_university)
                        #edu_obj.set_addr(addr_list[0], addr_list[1], addr_list[2], "USA", addr_list[3])
                        for key, val in qualification_word_dict.items():
                            if key in text:
                                edu_obj.degree = val
                                degree_flag = True
...
if __name__ == '__main__':
    ...
    agparser.add_argument('--filepath', type = str, required = True)
    file = agparser.parse_args().filepath
    obj = open(file,'rb')
